...
// Nombre distinto de verifyGrounding() de grounding-verify.js a proposito: ese
// comprueba una respuesta contra FUENTES que se le pasan aparte (opcode GROUND);
// este comprueba una respuesta contra la fuente que viene DENTRO de la propia
// pregunta (la clausula pegada, el documento citado en el enunciado), que es lo
// que puede correr en el pipeline de VERIFY sin que nadie aporte nada.
export function verifyQueryGrounding(text, query) {
